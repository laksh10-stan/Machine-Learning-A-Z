...
'''
#Working (USED)
#Building the optimal model using Backward Elimination (Manual Approach)
...
#Building the optimal model using Backward Elimination (Automated Approach and Optional)
